    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_type', models.CharField(default='r', choices=[('r', 'Reminder'), ('l', 'ReminderList')], max_length=1)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('privacy_type', models.CharField(default='p', choices=[('p', 'public'), ('o', 'onlyMe'), ('f', 'friends'), ('c', 'custom')], max_length=1)),
            ],
            options={
                'ordering': ('share_date',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('share_count', models.IntegerField(default=0)),
                ('comments_count', models.IntegerField(default=0)),
                ('list_privacy', models.CharField(default='p', choices=[('p', 'public'), ('o', 'onlyMe'), ('f', 'friends'), ('c', 'custom')], max_length=1)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(default='m', choices=[('f', 'Female'), ('m', 'Male'), ('o', 'Other')], max_length=1)),
                ('status', models.CharField(default='a', choices=[('a', 'active'), ('i', 'inactive'), ('s', 'suspended')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relation_type', models.CharField(default='p', choices=[('p', 'pending'), ('a', 'add'), ('f', 'follow'), ('b', 'block')], max_length=1)),
